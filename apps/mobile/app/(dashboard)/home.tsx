    ...
    <ScrollView className="flex-1 bg-gray-50">
      ...
      <View className="px-6 py-6">
        ...
        <View className="grid grid-cols-2 gap-4">
          ...
          <TouchableOpacity
            onPress={() => showToast.info('Settings', 'Settings coming soon!')}
            className="bg-white rounded-lg p-4 shadow-sm border border-gray-200"
          >
        ...
        <View className="bg-white rounded-lg p-4 shadow-sm border border-gray-200 mt-4">
          ...
          <View className="flex-row justify-between items-center">
            <View className="items-center">
              ...
              <Text className="text-gray-500 text-xs">Not Checked In</Text>
            </View>
            <View className="items-center">
              <Text className="text-2xl mb-1">⏰</Text>
            ...
            <View className="items-center">
              <Text className="text-2xl mb-1">📍</Text>
              <Text className="text-gray-500 text-xs">No Location</Text>
            </View>
          </View>
        </View>
