module.exports = {
  ...
  projects: [
    ...
    {
      displayName: "React Components/Hooks/Store (jsdom)",
      testMatch: ["<rootDir>/hooks/**/*.test.{ts,tsx}", "<rootDir>/components/**/*.test.{ts,tsx}", "<rootDir>/store/**/*.test.{ts,tsx}"],
      testEnvironment: "jsdom",
      setupFilesAfterEnv: ["<rootDir>/jest.setup.js"],
      setupFiles: ["<rootDir>/jest.polyfills.js"],
      moduleFileExtensions: ["ts", "tsx", "js", "jsx", "json", "native.js"],
    ...
    {
      displayName: "Services/Utils (node)",
      testMatch: ["<rootDir>/services/**/*.test.{ts,tsx}", "<rootDir>/utils/**/*.test.{ts,tsx}"],
