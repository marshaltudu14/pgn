 ...
 * Displays a sheet with farmer details and quick actions
 */
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="bottom" className="h-[90vh] overflow-y-auto px-4 lg:px-6">
        <SheetHeader>
          <SheetTitle>{farmer.name}</SheetTitle>
          <SheetDescription>
            Complete farmer information and all details
          </SheetDescription>
        </SheetHeader>
        ...
        <div className="mt-6 space-y-6">
            ...
            <div className="space-y-3 p-4 border rounded-lg">
              ...
              {farmer.address && (
                <div className="flex justify-between items-start">
                  ...
                  <p className="text-right text-gray-900 dark:text-gray-100 max-w-sm">{farmer.address}</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="flex gap-3 pt-4 border-t">
            ...
            {!hideEditButtons && onEdit && (
              <Button onClick={() => onEdit(farmer)} className="cursor-pointer flex-1">
